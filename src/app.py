...
def run_compiler():
    ...
    return jsonify({'lexerResult': {'tokens': "Tokens {}".format(str(tokens)), 'error': error}, 'parserResult': {'result': str(parse_result), 'error': parse_error, 'optimizedCode': optimized_code} })
