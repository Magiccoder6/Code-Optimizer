...
_lr_productions = [
  ...
  ('print_statement -> PRINT_KEYWORD LPAREN NAME RPAREN','print_statement',4,'p_print_statement','parser.py',21),
  ('print_statement -> PRINT_KEYWORD LPAREN NUMBER RPAREN','print_statement',4,'p_print_statement','parser.py',22),
  ('print_statement -> PRINT_KEYWORD LPAREN expression RPAREN','print_statement',4,'p_print_statement','parser.py',23),
  ('statement -> assignment_statement','statement',1,'p_statement','parser.py',29),
  ('statement -> expression_statement','statement',1,'p_statement','parser.py',30),
  ('assignment_statement -> NAME EQUALS expression','assignment_statement',3,'p_assignment_statement','parser.py',34),
  ('expression_statement -> expression','expression_statement',1,'p_statement_expr','parser.py',40),
  ('expression -> expression PLUS term','expression',3,'p_binary_operators','parser.py',44),
  ('expression -> expression MINUS term','expression',3,'p_binary_operators','parser.py',45),
  ('term -> term TIMES factor','term',3,'p_binary_operators','parser.py',46),
  ('term -> term DIVIDE factor','term',3,'p_binary_operators','parser.py',47),
  ('expression -> term','expression',1,'p_expression_term','parser.py',63),
  ('term -> factor','term',1,'p_term_factor','parser.py',67),
  ('factor -> NUMBER','factor',1,'p_factor_num','parser.py',71),
  ('factor -> NAME','factor',1,'p_factor_name','parser.py',75),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','parser.py',80),
]
